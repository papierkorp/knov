...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/logs/download": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "log file name (default: the active app.log)",
                        "name": "name",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "file logging not enabled",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/logs/file": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "log file name, or 'all' to merge every key's log",
                        "name": "name",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "lines to skip from the end, for paging a single file",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "return only the appended fragment, without the surrounding container",
                        "name": "chunk",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/files.BrokenLink"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/metadata/broken-links/repair": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "broken links repaired",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/testdata/mediatest": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "media test results",
                        "schema": {
                            "$ref": "#/definitions/test.SuiteResult"
                        }
                    },
        ...
        "/api/testdata/notificationtest": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "notification test results",
                        "schema": {
                            "$ref": "#/definitions/test.SuiteResult"
                        }
                    },
        ...
        "/api/testdata/settingstest": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "settings test results",
                        "schema": {
                            "$ref": "#/definitions/test.SuiteResult"
                        }
                    },
